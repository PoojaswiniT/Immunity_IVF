...
data_matrix <- as.matrix(df_ordered[, c("SampleID", "FF_IL12p70", "FF_IL4", "FF_TNFa", "Serum_IL13", "Serum_IL6", "Serum_IL8")])
...
color_group_list <- c("RIF" = "#eb4fb2", "Ctrl" = "#595959")

group_levels <- factor(df_avg$Group, levels = names(color_group_list))
